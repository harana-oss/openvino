...
ov::OutputVector normalizer_impl(const ov::frontend::onnx::Node& node) {
    ...
    auto reduction_axis = -1; // Always normalize along last axis
...
ONNX_OP("Normalizer", OPSET_SINCE(1), ai_onnx::opset_1::normalizer, AU_ONNX_ML_DOMAIN);
} // namespace opset_1
