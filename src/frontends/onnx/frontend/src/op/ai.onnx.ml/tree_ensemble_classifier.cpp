...
ONNX_OP("TreeEnsembleClassifier", OPSET_SINCE(1), ai_onnx_ml::opset_1::tree_ensemble_classifier, "ai.onnx.ml");
} // namespace opset_1
namespace opset_3 {
ov::OutputVector tree_ensemble_classifier(const ov::frontend::onnx::Node& node) { return ::ov::frontend::onnx::ai_onnx_ml::tree_ensemble_classifier(node); }
ONNX_OP("TreeEnsembleClassifier", OPSET_SINCE(3), ai_onnx_ml::opset_3::tree_ensemble_classifier, "ai.onnx.ml");
} // namespace opset_3
